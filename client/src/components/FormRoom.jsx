    ...
    if (isEmpty(selectedRoom)) {
      axios
        ...
        .then((data) => {
          ...
          toast.showSuccess("Created room");
          close();
        })
        .catch((err) => {
          console.log(err);
          toast.showError(err.response?.data?.message || "Failed create room");
        });
    } else {
      axios
        .post(
        ...
        .then((data) => {
          ...
          toast.showSuccess("Success updated room");
          close();
        })
        .catch((err) => {
          console.log(err);
