...
import MostActiveCustomers from "@/components/MostBookedCus";
import MostBookedRooms from "@/components/MostBookingRooms";
...
const Main = () => {
  ...
  useEffect (() => {
    axios.get (`${BE_PORT}/api/booking/invoicepaid`).then (response => {
      ...
      <div className='grid grid-cols-4 gap-[30px] mt-[25px] pb-[15px]'>
        ...
        <div
          ...
          <div>
            ...
            <h1
              className='text-[20px] leading-[24px] font-bold text-[#5a5c69] mt-[5px]'>{formatToVND (totalDiscountMonth)}</h1>
          </div>
        ...
        <div
          ...
          <div>
            ...
            <h1
              className='text-[20px] leading-[24px] font-bold text-[#5a5c69] mt-[5px]'>{formatToVND (totalDiscountYear)}</h1>
          </div>
          <FaRegCalendarMinus fontSize={28}/>
        </div>
        <div
          ...
          <div>
            ...
            <h1
              className='text-[20px] leading-[24px] font-bold text-[#5a5c69] mt-[5px]'>{formatToVND (totalDiscount)}</h1>
          </div>
          <FaRegCalendarMinus fontSize={28}/>
        </div>
        <div
        ...
        <div className='basis-[70%] border bg-white shadow-md cursor-pointer rounded-[4px]'>
          ...
          <div className="w-full">
            ...
            >
              ...
              <Legend/>
              <Line type="monotone" dataKey="Năm Nay" stroke="#8884d8" activeDot={{r: 8}}
                    name="Doanh thu năm hiện tại"/>
