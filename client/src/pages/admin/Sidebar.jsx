...
const Sidebar = () => {
  return (
    <div className="bg-[#003580] px-[25px] h-full">
      ...
      <Link
        to="Dashboard"
        className="no-underline flex items-center gap-[15px] py-[10px] border-b-[1px] border-[#EDEDED]/[0.3] cursor-pointer"
      >
        <FaTachometerAlt color="white" />
        <p className="text-[14px] leading-[20px] font-bold text-white pt-[10px]">
          Dashboard
        </p>
      </Link>
      <div className="pt-[15px] border-b-[1px] border-[#EDEDED]/[0.3]">
        ...
        <div className="flex items-center justify-between gap-[10px] py-[5px] cursor-pointer">
          ...
          >
            <FaHotel color="white" />{" "}
            <p className="text-[14px] leading-[20px] font-normal pt-[10px] text-white">
              Hotels
            </p>
          </Link>
