...
const InvoicesList = () => {
  ...
  const columns = [
    ...
    {title: "Số Điện Thoại", dataIndex: ["guestInfo", "phone"], key: "phone"},
    {
      ...
      dataIndex: "createDay",
      key: "createDay",
      render: (checkInDay) => new Date (checkInDay).toLocaleDateString ('vi-VN')
    },
    {title: "Phòng", dataIndex: ["roomID", "roomName"], key: "roomID"},
    {title: "Tổng Số Phòng", dataIndex: ["guestInfo", "totalRoom"], key: "totalRoom"},
    {
      title: "Ngày Nhận Phòng",
      dataIndex: ["guestInfo", "checkInDay"],
      key: "checkInDay",
      render: (checkInDay) => new Date (checkInDay).toLocaleDateString ('vi-VN')
    },
    {
      title: "Ngày Trả Phòng",
      dataIndex: ["guestInfo", "checkOutDay"],
      key: "checkOutDay",
      render: (checkOutDay) => new Date (checkOutDay).toLocaleDateString ('vi-VN')
    },
    {
      title: "Tổng Giá",
      dataIndex: ["guestInfo", "totalPrice"],
      key: "totalPrice",
