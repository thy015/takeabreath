...
function Room() {
  ...
  useEffect(() => {
    axios
      ...
      .catch((err) => {
        console.log(err);
        toast.showError(err.messagse || "Failed on loading room");
      });
  ...
  const handleDelete = (record) => {
    axios
      ...
      .then(() => {
        ...
        toast.showSuccess("Successfully deactivate room");
      })
      .catch((err) => {
        console.log(err);
        toast.showError(
          err.response?.data?.message || "Failed deactivate room"
        );
      });
  };
  ...
  const onChangeDate = (dates) => {
    if (!dates) {
      ...
      axios
        ...
        .catch((err) => {
          console.log(err);
          toast.showError(err.response?.data?.message || "Error filtering");
        });
    }
  };
