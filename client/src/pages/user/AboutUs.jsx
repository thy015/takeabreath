...
import {OurAchievementsCard, PressReleasesCarousel} from "@/components/AccommodationCard";
          ...
          <div className="row">
            ...
            <div className="col-8">
              ...
              <div className="relative inline-block mt-8">
                ...
                <button
                  className="relative bg-white text-black px-6 py-3 border border-black font-semibold flex items-center space-x-2">
        ...
        <div className="row g-0">
          ...
          <div className="col-8 p-5">
            <div className="relative flex justify-start pb-4">
              <div
                className="italic text-5xl font-oswald absolute transform translate-x-1 translate-y-0.5 text-slate-300">
                {" "}
                {t ('press-release')}
              </div>
        ...
        <div className="row">
          ...
          <div className="col-10">
            <div className="flex justify-between pb-4 font-oswald ">
              <div className="text-2xl pl-4"><span className='font-bold '>{t ('ourAchievements1')}</span>
                <span>{t ('ourAchievements2')}</span></div>
